...
(function() {
  ...
  unitTest = function() {
    return describe("diskspace", function() {
      it("sync osx", function() {
        return assert.deepEqual(diskspace.diskSpaceSync('Darwin', osxOutp), osxCanonicity);
      });
      ...
      it("async osx", function() {
        return diskspace.diskSpace(function(err, res) {
          return assert.deepEqual(res, osxCanonicity);
        }, 'Darwin', osxOutp);
      });
